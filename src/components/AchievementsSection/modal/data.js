export const modalObjOne = {
	...
	text:
		"Semi-Finalist in the WLU Lazaridis School of Business and Economics TD Case Study ",
};
export const modalObjTwo = {
	img: require("../../../images/achievements/img2.JPG"),
	alt: "clarendon",
	header: "Film Maker & Editor",
	text:
...
export const modalObjThree = {
	img: require("../../../images/achievements/img3.jpg"),
	alt: "volunteer",
	header: "Volunteer",
	text:
		"Volunteer for confirmation retreats and Knights of Columbus events at St John Chrysostom Church",
};
export const modalObjFour = {
	img: require("../../../images/achievements/img4.svg"),
	alt: "smart",
...
export const modalObjSix = {
	img: require("../../../images/achievements/img7.jpg"),
	alt: "frisbee",
	header: "Ultimate Frisbee Captain",
	text:
		"Captain of the Sacred Heart Catholic high school ultimate frisbee team",
};
